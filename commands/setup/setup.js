            ...
            new EmbedBuilder()
                ...
                .setDescription(
                    [
                        ...
                        '',
                        '**Next steps**',
                        '• `/team panel` — post the team join panel so members can pick a team.',
                        '• `/leaderboard post` — post the live team and player boards.',
                        '• `/tournament create` — open your first tournament.',
                        '',
